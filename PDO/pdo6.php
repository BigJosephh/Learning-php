...
<body>
    ...
    try {
        ...
        echo "Verotabanina Baglandi! " . "<br/>" . "<br/>";
    ...
    if ($Sorgu) {
        foreach ($Sorgu as $Satirlar) {
            ...
            echo "Kayit Tarihi: " . $Satirlar["kayittarihi"] . "<br/>" . "<br/>";
    ...
    if ($Sorgu) {
        foreach ($Sorgu as $Satirlar) {
            ...
            echo "Kullanici Sifresi : " . $Satirlar[1] . "<br/>";
            echo "Emailadresi : " . $Satirlar[2] . "<br/>";
            echo "Adi Soyadi : " . $Satirlar[3] . "<br/>";
            echo "Kayit Tarihi: " . $Satirlar[4] . "<br/>" . "<br/>";
